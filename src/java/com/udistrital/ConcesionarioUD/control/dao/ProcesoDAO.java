...
public class ProcesoDAO extends AbstractDao {
    ...
    public int actualizarEstadoProcesoAcuerdoPago(int idCotizacion,int idEmpleado) {
        String []partes = {"Acuerdo Pago"};
        Calendar calendar = Calendar.getInstance();
        String fecha = calendar.get(Calendar.DATE) + "/" + (calendar.get(Calendar.MONTH)+1) + "/" + calendar.get(Calendar.YEAR);
        int r = 0;
        for (String parte : partes) {
    ...
    public int actualizarEstadoProcesoEstudioCredito(int idCotizacion, int idEmpleado) {
        String []partes = {"Estudio Credito"};
        Calendar calendar = Calendar.getInstance();
        String fecha = calendar.get(Calendar.DATE) + "/" + (calendar.get(Calendar.MONTH)+1) + "/" + calendar.get(Calendar.YEAR);
        int r = 0;
        for (String parte : partes) {
