...
public final class ConsultasVenta {
    ...
    public static String getBuscarcotizacionAprobarCreditoPorCCCliente(String cedula) {
        return "SELECT"
                + "    c.IDCOTIZACION,"
                + "    c.FECHAEXPEDICION,"
                + "    c.TOTAL,"
    ...
    public static String getBuscarcotizacionEstudioCreditoPorCCCliente(String cedula) {
        return "SELECT"
                + "    c.IDCOTIZACION,"
                + "    c.FECHAEXPEDICION,"
                + "    c.TOTAL,"
                ...
                + "AND AU.VIN = MARCA.VIN "
                + "AND AU.VIN = LINEA.VIN "
                + "AND P.IDCOTIZACION = c.IDCOTIZACION "
                + "AND P.IDTIPOPROCESO = (SELECT IDTIPOPROCESO FROM TIPOPROCESO WHERE LOWER(ESTADOPROCESO) = 'estudio credito')"
                + "AND MONTHS_BETWEEN(SYSDATE, c.FECHAEXPEDICION) < 1 "
                + "AND cl.CEDULA = " + cedula;
    }

    public static String getBuscarcotizacionSepararAutoPorCCCliente(String cedula) {
        return "SELECT"
                + "    c.IDCOTIZACION,"
                + "    c.FECHAEXPEDICION,"
                + "    c.TOTAL,"
                ...
                + "AND AU.VIN = LINEA.VIN "
                + "AND P.IDCOTIZACION = c.IDCOTIZACION "
                + "AND (P.IDTIPOPROCESO = (SELECT IDTIPOPROCESO FROM TIPOPROCESO WHERE LOWER(ESTADOPROCESO) = 'acuerdo de pago')"
                + "OR P.IDTIPOPROCESO = (SELECT IDTIPOPROCESO FROM TIPOPROCESO WHERE LOWER(ESTADOPROCESO) = 'acuerdo pago credito'))"
                + "AND MONTHS_BETWEEN(SYSDATE, c.FECHAEXPEDICION) < 1 "
                + "AND cl.CEDULA = " + cedula;       
    }
}
